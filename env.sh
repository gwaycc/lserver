...
# -------------------------------------------------
export PRJ_ROOT=`pwd`
export PRJ_NAME="lserver"
export GOBIN=$PRJ_ROOT/bin
export GO111MODULE=on

# 设定sup [command] all 所遍历的目录
export BUILD_ALL_PATH="$PRJ_ROOT/service/log $PRJ_ROOT/service/beh $PRJ_ROOT/applet/cms"
...
if [ ! -f $GOBIN/sup ]; then
    ...
    mkdir -p $GOBIN&& \
    curl https://raw.githubusercontent.com/gwaycc/supd/v1.0.0/bin/sup -o $GOBIN/sup && \
